...
class ProductGridFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as AppCompatActivity).setSupportActionBar(view.product_grid_app_bar)
        view.product_grid_app_bar.setNavigationOnClickListener(NavigationIconClickListener(
            activity!!,
            view.product_grid,
        ...
        view.recycler_view.addItemDecoration(ProductGridItemDecoration(smallPadding))
